...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // Configure the cell...
    NSString* titulo=[[single.info objectAtIndex:indexPath.row] titulo];
    NSString* frase=[[single.info objectAtIndex:indexPath.row] frase] ;
